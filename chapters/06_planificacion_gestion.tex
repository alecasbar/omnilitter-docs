...
dependencias, repartir el trabajo en incrementos manejables y revisar los riesgos más relevantes
en cada etapa.
...
Estas dependencias condicionaron el orden de desarrollo previsto. En particular, no era
...
\subsection{Estimación inicial de esfuerzo}

En la fase de análisis no se conocía todavía el detalle de todas las tareas que
sería necesario abordar durante el desarrollo. Por este motivo, la planificación
inicial no se formuló como una distribución cerrada por sprints, sino como una
estimación por bloques de trabajo. Los sprints se utilizaron posteriormente como
mecanismo operativo de seguimiento y adaptación del backlog, pero no como una
predicción rígida definida al comienzo del proyecto.

La estimación inicial se realizó a partir del alcance previsto y de la carga
esperada para un proyecto desarrollado por dos personas. Se consideró un esfuerzo
global de 600 horas, distribuidas entre análisis, diseño, implementación, pruebas,
despliegue, documentación, revisión final de la memoria y preparación de los
materiales de defensa.

\begin{table}[H]
\centering
\caption{Estimación inicial de esfuerzo por bloques de trabajo}
\label{tab:estimacion_inicial_esfuerzo}
\small
\renewcommand{\arraystretch}{1.18}
\begin{tabularx}{\textwidth}{X>{\raggedleft\arraybackslash}p{2.4cm}X}
\toprule
\textbf{Bloque de trabajo planificado} & \textbf{Horas estimadas} & \textbf{Justificación} \\
\midrule
Análisis, planificación y gestión del proyecto & 48,00 h & Reuniones iniciales, definición de alcance, organización del backlog y coordinación con cliente y tutor. \\
Diseño funcional, UX y prototipado & 48,00 h & Mockups, revisión de flujos de usuario y validación temprana de la solución. \\
Arquitectura, configuración y base técnica & 62,00 h & Monorepo, entorno de desarrollo, CI/CD, Docker, Prisma y estructura común del sistema. \\
Implementación de backend y modelo de datos & 72,00 h & API, autenticación, permisos, entidades principales, validaciones y persistencia en PostgreSQL. \\
Implementación del portal web & 58,00 h & Gestión, consulta, filtros, administración, visualización y explotación de datos desde navegador. \\
Implementación de la aplicación móvil y soporte offline & 82,00 h & Captura en campo, sesiones, observaciones, fotografías, GPS, SQLite y funcionamiento sin conexión. \\
Integración, sincronización, analítica y exportación & 68,00 h & Conexión entre módulos, sincronización diferida, mapas, métricas y exportaciones científicas. \\
Pruebas, validación y estabilización & 52,00 h & Pruebas automatizadas, pruebas manuales, corrección de incidencias y regresión funcional. \\
Despliegue, releases y documentación técnica & 32,00 h & Preparación de entornos, publicación de versiones, builds y manuales técnicos. \\
Memoria, revisión final, vídeo y presentación & 78,00 h & Redacción de la memoria, anexos, revisión final, preparación del vídeo y presentación de defensa. \\
\midrule
\textbf{Total estimado} & \textbf{600,00 h} & Estimación inicial del esfuerzo completo del proyecto para el equipo de trabajo. \\
\bottomrule
\end{tabularx}
\end{table}

Esta estimación sirvió como referencia inicial para valorar la viabilidad del
proyecto y reservar margen suficiente para actividades que no forman parte directa
de la programación, pero que resultan necesarias en un proyecto académico de estas
características: validación con el cliente, documentación, revisión de la memoria y
preparación de la defensa. La medición real de horas se presenta posteriormente en
las conclusiones, separada de esta planificación inicial.

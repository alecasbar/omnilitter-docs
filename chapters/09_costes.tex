...
elaboración de la memoria. La dedicación registrada entre los dos integrantes del
equipo asciende a \textbf{593,26 horas} de trabajo.
...
\midrule
Planificación inicial & 42,50 h & 637,50 EUR & Incluye reuniones iniciales, análisis del alcance, organización del backlog y planificación de sprints. \\
...
\midrule
\textbf{Total} & \textbf{593,26 h} & \textbf{8.898,90 EUR} & Coste imputado del esfuerzo de desarrollo del equipo. \\
\bottomrule
\end{tabularx}
\end{table}
...
Margen general de cierre & Baja & 50,39 EUR & Correcciones menores, revisión final, pruebas regresivas y ajustes documentales de última hora. \\
\midrule
\textbf{Total contingencia} & -- & \textbf{923,39 EUR} & Reserva equivalente al 10\% del coste base del proyecto. \\
\bottomrule
\end{tabularx}
\end{table}
...
\midrule
Costes de personal & 8.898,90 EUR \\
...
Reserva de contingencia & 923,39 EUR \\
\midrule
\textbf{Coste total estimado} & \textbf{10.157,29 EUR} \\
\bottomrule
\end{tabularx}
\end{table}

Por tanto, el coste económico estimado de OmniLitter asciende a
\textbf{10.157,29 EUR} incluyendo contingencia. Esta cifra debe interpretarse como
